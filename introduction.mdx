---
title: Introduction to OpenGeometry
description: A high-performance CAD kernel for the web, bringing professional 3D geometry operations to your browser
---
...
With TypeScript bindings and seamless Three.js integration, OpenGeometry makes it easy to build sophisticated CAD applications, 3D modeling tools, architectural visualization software, and interactive geometry editors for the web.
